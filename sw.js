...
// Read build version from the registration URL (index.html registers as sw.js?v=BUILD_TIME)
// so the cache name actually changes on every deploy and old caches get evicted below.
const _buildVer = new URLSearchParams(self.location.search).get('v') || 'v1';
const SW_VERSION = 'metpower-' + _buildVer;
