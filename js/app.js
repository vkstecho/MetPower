...
const EMP_ROLES = {
  // M-1 Main Operators
  'NITISH':       { role:'main',     section:'M1', order:1 },
  'SURYA PRATAP': { role:'main',     section:'M1', order:2 },
  // M-2 Main Operators  
  'NEERAJ KUMAR': { role:'main',     section:'M2', order:1 },
  'SHIVAM':       { role:'main',     section:'M2', order:2 },
  // Metalliser Relievers
  'ROSHAN':       { role:'reliever', section:'M2', order:3 },
  'MEHER CHAND':  { role:'reliever', section:'M1', order:3 },
  // Metalliser Assistants (rest)
  'SOURAV KUMAR': { role:'assist',   section:'M1', order:4 },
  'ABHISHEK':     { role:'assist',   section:'M1', order:5 },
  'SANDEEP':      { role:'assist',   section:'M1', order:6 },
  'NITIN':        { role:'assist',   section:'M1', order:7 },
  'AVINASH YADAV':{ role:'assist',   section:'M2', order:4 },
  'ANKIT':        { role:'assist',   section:'M2', order:5 },
  // S-1 Main Operators
  'ISHWAR':       { role:'main',     section:'S1', order:1 },
  'PARVEZ ALI':   { role:'main',     section:'S1', order:2 },
  // S-2 Main Operators
  'HARIOM':       { role:'main',     section:'S2', order:1 },
  'ARIF':         { role:'main',     section:'S2', order:2 },
  // Slitter Relievers
  'SANJAY':       { role:'slit_rel', section:'S1', order:3 },
  // Slitter Others
  'HARISHARAN':   { role:'assist',   section:'S1', order:4 },
  'VINOD PAL':    { role:'assist',   section:'S1', order:5 },
  'DHARAMVEER':   { role:'assist',   section:'S2', order:3 },
  // Supervisors — Slitter first
  'GURPREET':     { role:'sup_slit', section:'SUP', order:1 },
  'MANJEET':      { role:'sup_slit', section:'SUP', order:2 },
  // Supervisors — Metalliser
  'MOHIT':        { role:'sup_met',  section:'SUP', order:3 },
  'GHANSHYAM':    { role:'sup_met',  section:'SUP', order:4 },
  'ANUJ':         { role:'sup_met',  section:'SUP', order:5 },
  'DISHANT':      { role:'sup_met',  section:'SUP', order:6 },
  // Manager
  'VIVEK':        { role:'mgr',      section:'MGR', order:1 },
};
...
const DEFAULT_EMP = [
  // ── M-1 (Metalliser-1) ──
  {id:'e01',name:'NITISH',       empId:'30000422',sec:'M1',mc:'M-1',    resp:'Operation',woff:'TUE',status:'active',phone:'',designation:'Team Member',      joiningDate:'',         dob:'',           ms:['N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'L', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'C/O', 'C/O', 'C/O', 'O']},
  {id:'e02',name:'SURYA PRATAP', empId:'30000520',sec:'M1',mc:'M-1',    resp:'Setup',    woff:'WED',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'2025-09-01',dob:'',           ms:['D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D']},
  {id:'e03',name:'SOURAV KUMAR', empId:'30000514',sec:'M1',mc:'M-1&2',  resp:'Setup',    woff:'WED',status:'active',phone:'',designation:'Team Member',      joiningDate:'2025-08-12',dob:'',           ms:['GP', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D']},
  {id:'e04',name:'ABHISHEK',     empId:'30000436',sec:'M1',mc:'M-1&2',  resp:'5S',       woff:'FRI',status:'active',phone:'',designation:'Trainee',          joiningDate:'',         dob:'',           ms:['D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D']},
  {id:'e05',name:'SANDEEP',      empId:'30000197',sec:'M1',mc:'M-1&2',  resp:'Setup',    woff:'SAT',status:'active',phone:'',designation:'Jr. Team Member',  joiningDate:'',         dob:'',           ms:['D', 'O', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'L', 'L', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N']},
  {id:'e06',name:'NITIN',        empId:'30000171',sec:'M1',mc:'M-1&2',  resp:'5S',       woff:'SUN',status:'active',phone:'',designation:'Jr. Team Member',  joiningDate:'',         dob:'',           ms:['O', 'L', 'D', 'D', 'D', 'D', 'O', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D']},
  {id:'e07',name:'MEHER CHAND',  empId:'30000481R', sec:'M1',mc:'M-1&2', resp:'Setup',   woff:'',   status:'active',phone:'',designation:'Team Member',      joiningDate:'2026-02-20',dob:'',           ms:['D', 'GP', 'C/O', 'H', 'D', 'D', 'D', 'D', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D']},
  // ── M-2 (Metalliser-2) ──
  {id:'e08',name:'NEERAJ KUMAR', empId:'30000517',sec:'M2',mc:'M-2',    resp:'Operation',woff:'THU',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'2025-09-01',dob:'',           ms:['D', 'D', 'D', 'D', 'O', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D']},
  {id:'e09',name:'SHIVAM',       empId:'30000521',sec:'M2',mc:'M-2',    resp:'Operation',woff:'FRI',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'2025-09-01',dob:'',           ms:['D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D']},
  {id:'e10',name:'ROSHAN',       empId:'30000365',sec:'M2',mc:'M-1&2',  resp:'Operation',woff:'SAT',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'',         dob:'',           ms:['N', 'N', 'C/O', 'H', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N']},
  {id:'e11',name:'AVINASH YADAV',empId:'30000532',sec:'M2',mc:'M-1&2',  resp:'Setup',    woff:'THU',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'2025-11-01',dob:'',           ms:['N', 'N', 'N', 'D', 'O', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N']},
  {id:'e12',name:'ANKIT',        empId:'30000369',sec:'M2',mc:'M-2',    resp:'Setup',    woff:'MON',status:'active',phone:'',designation:'Jr. Team Member',  joiningDate:'',         dob:'',           ms:['N', 'O', 'N', 'L', 'L', 'L', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N']},
  // ── S-1 (Slitter-1) ──
  {id:'e13',name:'ISHWAR',       empId:'30000361',sec:'S1',mc:'S-1',    resp:'Operation',woff:'SUN',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'',         dob:'',           ms:['D', 'O', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'N', 'D', 'D', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N']},
  {id:'e14',name:'PARVEZ ALI',   empId:'30000266',sec:'S1',mc:'S-1',    resp:'Operation',woff:'SAT',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'',         dob:'',           ms:['N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'O', 'L', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D']},
  {id:'e15',name:'SANJAY',       empId:'30000348',sec:'S1',mc:'S-1/2',  resp:'Operation',woff:'MON',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'',         dob:'',           ms:['L', 'O', 'D', 'H', 'D', 'D', 'D', 'D', 'O', 'L', 'L', 'L', 'L', 'L', 'L', 'O', 'L', 'L', 'L', 'L', 'L', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'D']},
  {id:'e16',name:'HARISHARAN',   empId:'30000522',sec:'S1',mc:'S-1/2',  resp:'Setup',    woff:'TUE',status:'active',phone:'',designation:'Team Member',      joiningDate:'2025-09-01',dob:'',           ms:['N', 'N', 'O', 'D', 'D', 'D', 'D', 'O', 'L', 'L', 'L', 'L', 'L', 'L', 'O', 'L', 'L', 'L', 'L', 'L', 'L', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D']},
  {id:'e17',name:'VINOD PAL',    empId:'30000544', sec:'S1',mc:'S-1/2', resp:'Setup',    woff:'WED',status:'active',phone:'',designation:'Team Member',      joiningDate:'2026-01-09',dob:'',           ms:['Ab', 'D', 'D', 'D', 'GP', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N']},
  // ── S-2 (Slitter-2) ──
  {id:'e18',name:'HARIOM',       empId:'30000495',sec:'S2',mc:'S-2',    resp:'Operation',woff:'THU',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'2025-06-01',dob:'',           ms:['D', 'D', 'GP', 'D', 'O', 'D', 'D', 'D', 'D', 'D', 'O', 'D', 'D', 'D', 'D', 'D', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'D', 'D', 'D', 'D', 'D', 'O', 'D']},
  {id:'e19',name:'ARIF',         empId:'30000210',sec:'S2',mc:'S-2',    resp:'Operation',woff:'FRI',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'',         dob:'',           ms:['N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'C/O', 'O', 'L', 'L', 'N', 'N', 'N', 'N', 'N', 'N', 'O']},
  {id:'e20',name:'DHARAMVEER',   empId:'30000524',sec:'S2',mc:'S-1/2',  resp:'Setup',    woff:'WED',status:'active',phone:'',designation:'Team Member',      joiningDate:'2025-09-07',dob:'',           ms:['O', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'N', 'C/O', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O']},
  // ── SUP (Supervisors / Engineers) ──
  {id:'e21',name:'GURPREET',     empId:'30000430',sec:'SUP',mc:'S.I.',  resp:'P,Q,M',    woff:'TUE',status:'active',phone:'',designation:'Jr. Engineer',     joiningDate:'2024-10-18',dob:'1999-08-08', ms:['O', 'D', 'D', 'D', 'D', 'D', 'HLF', 'O', 'C/O', 'C/O', 'L', 'L', 'L', 'L', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N']},
  {id:'e22',name:'MANJEET',      empId:'30000263',sec:'SUP',mc:'S-1/2', resp:'P,Q,M',    woff:'MON',status:'active',phone:'',designation:'Jr. Team Member',  joiningDate:'',         dob:'',           ms:['D', 'O', 'N', 'N', 'L', 'L', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N']},
  {id:'e23',name:'DISHANT',      empId:'30000506',sec:'SUP',mc:'S.I.',  resp:'P,Q,M',    woff:'FRI',status:'active',phone:'',designation:'Jr. Engineer',     joiningDate:'2025-07-23',dob:'2001-03-17', ms:['O', 'D', 'D', 'H', 'D', 'D', 'D', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'D', 'D']},
  {id:'e24',name:'ANUJ',         empId:'30000227',sec:'SUP',mc:'S.I.',  resp:'P,Q,M',    woff:'SUN',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'',         dob:'',           ms:['O', 'D', 'D', 'H', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D']},
  {id:'e25',name:'GHANSHYAM',    empId:'30000201',sec:'SUP',mc:'M-1&2', resp:'P,Q,M',    woff:'MON',status:'active',phone:'',designation:'Sr. Team Member',  joiningDate:'',         dob:'',           ms:['D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N']},
  {id:'e26',name:'MOHIT',        empId:'30000426',sec:'SUP',mc:'S.I.',  resp:'P,Q,M',    woff:'THU',status:'active',phone:'',designation:'GET',              joiningDate:'',         dob:'',           ms:['N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'D', 'D', 'D', 'D', 'D', 'D', 'O', 'N', 'N', 'N']},
  // ── MGR (Manager) ──
  {id:'e27',name:'VIVEK',        empId:'30000463',sec:'MGR',mc:'ALL',   resp:'Manager',  woff:'FRI',status:'active',phone:'',designation:'Production Manager',joiningDate:'',         dob:'',           ms:['G', 'G', 'G', 'G', 'G', 'O', 'G', 'G', 'G', 'G', 'G', 'G', 'O', 'G', 'G', 'G', 'G', 'G', 'G', 'O', 'G', 'G', 'G', 'G', 'G', 'G', 'O', 'G', 'G', 'G', 'G']},
];

// ── LEFT / RESIGNED EMPLOYEES (from Excel: Left_Replaced sheet) ──
const DEFAULT_LEFT_EMP = [
  {id:'left_30000155',empId:'30000155',name:'SURENDER',      designation:'Sr. Team Member',phone:'',          mc:'MET',  sec:'M1',  joiningDate:'',         leftAt:'2024-10-01T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left in Oct 2024',                             replacedBy:'Harjinder'},
  {id:'left_30000216',empId:'30000216',name:'AMARNATH',      designation:'Sr. Team Member',phone:'',mc:'MET',  sec:'M1',  joiningDate:'',         leftAt:'2025-03-10T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 10.03.2025 without notice period',     replacedBy:'Shailendra'},
  {id:'left_30000218',empId:'30000218',name:'LAKINDER',      designation:'Sr. Team Member',phone:'',mc:'MET',  sec:'M1',  joiningDate:'',         leftAt:'2025-03-16T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 16.03.2025 without notice period',     replacedBy:'Rajkumar'},
  {id:'left_30000279',empId:'30000279',name:'ARVIND',        designation:'Sr. Team Member',phone:'',mc:'SLIT', sec:'S1',  joiningDate:'',         leftAt:'2025-04-01T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left in April 2025',                           replacedBy:'Jai Kumar'},
  {id:'left_30000429',empId:'30000429',name:'VIKRAM',        designation:'Trainee',         phone:'',mc:'MET',  sec:'M1',  joiningDate:'',         leftAt:'2025-04-01T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left in April 2025',                           replacedBy:''},
  {id:'left_30000154',empId:'30000154',name:'SURAJ',         designation:'Sr. Team Member',phone:'',mc:'SLIT', sec:'S1',  joiningDate:'',         leftAt:'2025-05-10T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 10.05.2025',                           replacedBy:'Hariom'},
  {id:'left_30000404',empId:'30000404',name:'AMIT CHAUBEY',  designation:'Team Member',     phone:'',mc:'MET',  sec:'M1',  joiningDate:'',         leftAt:'2025-05-13T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 13.05.2025',                           replacedBy:'Himanshu'},
  {id:'left_30000405',empId:'30000405',name:'CHANDAN',       designation:'Sr. Team Member',phone:'',mc:'MET',  sec:'M1',  joiningDate:'',         leftAt:'2025-05-25T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 25.05.2025',                           replacedBy:'Gaurav'},
  {id:'left_30000408',empId:'30000408',name:'NALINIKANTA JENA',designation:'Engineer',      phone:'',mc:'ENGG', sec:'SUP', joiningDate:'2024-08-01',leftAt:'2025-06-15T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 15.06.2025',                           replacedBy:'Ajab Singh'},
  {id:'left_30000470',empId:'30000470',name:'SHAILENDRA KUMAR',designation:'Sr. Team Member',phone:'',mc:'MET', sec:'M1',  joiningDate:'2025-04-11',leftAt:'2025-06-09T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 09.06.2025',                           replacedBy:''},
  {id:'left_30000492',empId:'30000492',name:'RITESH CHOUHAN',designation:'Shift Engineer',  phone:'',          mc:'ENGG', sec:'SUP', joiningDate:'2025-05-31',leftAt:'2025-07-09T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 09.07.2025',                           replacedBy:'Dishant'},
  {id:'left_30000497',empId:'30000497',name:'HARJINDER',     designation:'Team Member',     phone:'',          mc:'ENGG', sec:'SUP', joiningDate:'2025-05-31',leftAt:'2025-07-09T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 09.07.2025',                           replacedBy:''},
  {id:'left_30000411',empId:'30000411',name:'SAGAR',         designation:'Sr. Team Member',phone:'',mc:'SLIT', sec:'S1',  joiningDate:'',         leftAt:'2025-08-20T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 20.08.2025',                           replacedBy:''},
  {id:'left_30000483',empId:'30000483',name:'SATINDER ATTRI',designation:'Sr. Manager',     phone:'',          mc:'All',  sec:'MGR', joiningDate:'2025-05-16',leftAt:'2025-08-28T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 28.08.2025',                           replacedBy:''},
  {id:'left_30000518',empId:'30000518',name:'SURAJ (TL)',    designation:'Team Leader',     phone:'',mc:'MET',  sec:'M1',  joiningDate:'2025-09-01',leftAt:'2025-10-11T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 11.10.2025 Confirmed on Whatsapp',     replacedBy:'Anup'},
  {id:'left_30000474',empId:'30000474',name:'JAY KUMAR',     designation:'Sr. Team Member',phone:'',mc:'SLIT', sec:'S1',  joiningDate:'2025-04-22',leftAt:'2025-11-12T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 12.11.2025',                           replacedBy:'Vinod'},
  {id:'left_30000481',empId:'30000481',name:'RAJKUMAR',      designation:'Sr. Team Member',phone:'',mc:'MET',  sec:'M1',  joiningDate:'2025-05-10',leftAt:'2025-11-18T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 18.11.2025',                           replacedBy:'Meher Chand'},
  {id:'left_30000507',empId:'30000507',name:'HIMANSHU',      designation:'Sr. Team Member',phone:'',mc:'MET',  sec:'M1',  joiningDate:'2025-07-24',leftAt:'2025-12-06T00:00:00.000Z',leftReason:'terminated', leftStatusNote:'Terminated on 06.12.2025',                     replacedBy:''},
  {id:'left_30000510',empId:'30000510',name:'GAURAV',        designation:'Sr. Team Member',phone:'',mc:'MET',  sec:'M1',  joiningDate:'2025-07-28',leftAt:'2025-12-08T00:00:00.000Z',leftReason:'terminated', leftStatusNote:'Terminated on 08.12.2025',                     replacedBy:''},
  {id:'left_30000493',empId:'30000493',name:'AJAB SINGH',    designation:'Shift Engineer',  phone:'',mc:'ENGG', sec:'SUP', joiningDate:'2025-05-31',leftAt:'2026-02-10T00:00:00.000Z',leftReason:'resigned',   leftStatusNote:'Left on 10.02.2026',                           replacedBy:''},
];

// ── NCR RECORDS (Non-Conformance Reports) ──
const NCR_DATA = [
  {ncr:1,  year:2025,date:'2025-01-20',reason:'5.5 mt roll downgrade',names:['NITISH']},
  {ncr:2,  year:2025,date:'2025-01-20',reason:'The Actual width is greater than the planing roll',names:['PARVEZ ALI']},
  {ncr:3,  year:2024,date:'2024-12-10',reason:'Negligence during inspection of the shield, boat, and rollers before closing the chamber',names:['NK JENA']},
  {ncr:4,  year:2025,date:'2025-02-20',reason:'Metal Piece Sent to Recycle Plant in Bare scrap "Potli"',names:['SANJAY']},
  {ncr:5,  year:2025,date:'2025-03-03',reason:'Incorrect Slitting Entry',names:['SOURAV KUMAR']},
  {ncr:6,  year:2025,date:'2025-03-11',reason:'Both Side Tape not used at Starting of Slitting a Roll at Core end to Join Film to Core',names:['ARIF']},
  {ncr:7,  year:2025,date:'2025-04-01',reason:'DP Foreline Dead Plug opened for Valve sheet cleaning',names:['ROSHAN','MOHIT']},
  {ncr:9,  year:2025,date:'2025-04-03',reason:'Wrong Micron mentioned in slitting Entry in roll number GMA25C01460',names:['MOHIT']},
  {ncr:10, year:2025,date:'2025-04-04',reason:'At met Slitter-1 metallised roll job card was missing',names:['SOURAV KUMAR']},
  {ncr:11, year:2025,date:'2025-04-08',reason:'At met Slitter-1 Wrong size slitting due to Negligence at work',names:['MANJEET']},
  {ncr:12, year:2025,date:'2025-04-15',reason:'Met waste Weighing not done even after training',names:['SOURAV KUMAR','PARVEZ ALI']},
  {ncr:14, year:2025,date:'2025-06-25',reason:'Customer Complain due to Wrong sticker paste in April 2025',names:['PARVEZ ALI']},
  {ncr:15, year:2025,date:'2025-06-25',reason:'Wet Aluminum Dust Scrap with Plastic and cloth waste mixed kept in open',names:['ANUJ','NITIN']},
  {ncr:16, year:2025,date:'2025-07-09',reason:'While Slitting Entry two rolls weight not mentioned in logbook on 04.07.2025',names:['SOURAV KUMAR']},
  {ncr:17, year:2025,date:'2025-07-09',reason:'Absent from duty on 07.07.2025 without any information',names:['SOURAV KUMAR']},
  {ncr:18, year:2025,date:'2025-07-09',reason:'Bare Roll GMA25G01314 metallised without Job card, complete jumbo down gradation due to Low metal',names:['SANDEEP','ANUJ','MOHIT']},
  {ncr:19, year:2025,date:'2025-07-09',reason:'Bare Roll GA25G01324 wrongly metallised in 2.8 OD, planning was 3.0 OD',names:['ANUJ']},
  {ncr:20, year:2025,date:'2025-07-09',reason:'Bare Roll GA25G01322 wrongly metallised in 2.8 OD, planning was 3.0 OD',names:['GHANSHYAM']},
  {ncr:21, year:2025,date:'2025-09-10',reason:'Roll sitting done without checking Pending orders, Huge stock of Un-allocated material generated',names:['MOHIT']},
  {ncr:22, year:2025,date:'2025-09-14',reason:'Roll GMB25I0419 Wrong size Entry — Actual 1115MM, SAP entry 1135mm',names:['MOHIT']},
  {ncr:23, year:2025,date:'2025-09-19',reason:'Bare Roll GA25H04352 wrongly metallised on Chemical Coated surface instead of Corota Treated surface',names:['ANUJ']},
  {ncr:25, year:2025,date:'2025-10-16',reason:'During Met Jumbo GJMA251885 Production Entry, Met Sheet Waste Booked 33.3 MT',names:['DISHANT']},
  {ncr:27, year:2025,date:'2025-11-17',reason:'Wrong Length Slit from 3000mm Jumbo on 15.11.2025 Night shift — 28500m vs 24000m',names:['GURPREET']},
  {ncr:28, year:2025,date:'2025-12-21',reason:'Evaporation Boats Register not maintained properly',names:['DISHANT']},
  {ncr:29, year:2025,date:'2025-12-26',reason:'Low OD Downgradation and action not taken at metalliser',names:['NEERAJ KUMAR']},
  {ncr:30, year:2025,date:'2025-12-28',reason:'Material Slit Worn side — Order INSIDE, slitting done OUTSIDE',names:['GURPREET']},
  {ncr:31, year:2025,date:'2025-12-30',reason:'Absent from Duty without any Approval on 21.11.2025',names:['PARVEZ ALI']},
  {ncr:32, year:2025,date:'2025-12-31',reason:'Excessive Usable Waste generated due to Wrong Production Entry',names:['DISHANT','ANUJ']},
  {ncr:'26-1',year:2026,date:'2026-01-11',reason:'7 MT Material G23320SM28 Downgraded — Bare side Chemical Patches in MD Direction',names:['MOHIT','NITISH','SOURAV KUMAR','GHANSHYAM','SURYA PRATAP']},
  {ncr:'26-2',year:2026,date:'2026-01-20',reason:'Wrong Timing and Speed Entry for Met Jumbo GJMA260121',names:[]},
  {ncr:'26-3',year:2026,date:'2026-01-21',reason:'MET SOP 19 not followed, Web break — Unwinder Stop Diameter incorrect in Paper Core',names:['SHIVAM']},
  {ncr:'26-4',year:2026,date:'2026-01-21',reason:'Roll movement done without core plug on 20.01.2026',names:['ARIF']},
  {ncr:'26-5',year:2026,date:'2026-01-21',reason:'Paper Core Used in Roll Weight 2400 Kgs',names:['ANUJ']},
  {ncr:'26-6',year:2026,date:'2026-01-27',reason:'Hawkeye Beam support plates were Loose, shift person did not check sample after metallisation',names:['GHANSHYAM','ABHISHEK','SURYA PRATAP','SHIVAM']},
  {ncr:'26-7',year:2026,date:'2026-02-01',reason:'After strict instructions not to book in order, order booking was still done',names:['MANJEET']},
  {ncr:'26-9',year:2026,date:'2026-03-02',reason:'10320SM28 Material Roll slit in 2.2 OD, Job card not checked',names:['GURPREET','DHARAMVEER']},
  {ncr:'26-10',year:2026,date:'2026-03-02',reason:'12360M25 Roll slippage 2630mm on 01.03.2026 produced from Met-1',names:['SHIVAM']},
  {ncr:'26-11',year:2026,date:'2026-03-02',reason:'Wrong Roll Handover at Met Slitter-1 — 2.8 OD handover, planning was 2.2 OD',names:['PARVEZ ALI','MOHIT']},
  {ncr:'26-12',year:2026,date:'2026-03-03',reason:'Wrong Size slitting 1000mm, order requirement 1010MM, Roll GMA26B0454',names:['VINOD PAL']},
  {ncr:'26-13',year:2026,date:'2026-03-03',reason:'Small Sized Roll ID Stickers not Pasted in Day Shift on 03.03.2026',names:['GURPREET']},
];

const NCR_NAME_MAP = {
  'NITIN':'e06','NITISH':'e01','SANDEEP':'e05','GHANSHYAM':'e25','ARIF':'e19',
  'ANUJ':'e24','MANJEET':'e22','PARVEZ ALI':'e14','PARVEZ':'e14','SANJAY':'e15',
  'ISHWAR':'e13','ROSHAN':'e10','ANKIT':'e12','MOHIT':'e26','GURPREET':'e21',
  'ABHISHEK':'e04','HARIOM':'e18','DISHANT':'e23','SOURAV KUMAR':'e03','SOURAV':'e03',
  'NEERAJ KUMAR':'e08','NEERAJ':'e08','SURYA PRATAP':'e02','SURYA':'e02',
  'SHIVAM':'e09','HARISHARAN':'e16','DHARAMVEER':'e20','DHARAMBIR':'e20',
  'AVINASH YADAV':'e11','AVINASH':'e11','VINOD PAL':'e17','VINOD':'e17',
  'MEHER CHAND':'e07','VIVEK':'e27',
};

function getNcrForEmp(empId){
  return NCR_DATA.filter(n => n.names.some(nm => NCR_NAME_MAP[nm] === empId));
}
...
function getSchedFilteredEmps(){
  ...
  if(schedSec==='GRP:metalliser'){
    const cfg=getShiftConfigSync();
    const metKeys=new Set((cfg.metallisers||[]).map(_normSecKey));
    return all.filter(e=>{ const k=_normSecKey(e.sec); return k==='MET' || metKeys.has(k); });
  }
  if(schedSec==='GRP:slitter'){
    const cfg=getShiftConfigSync();
    const slitKeys=new Set((cfg.slitters||[]).map(_normSecKey));
    return all.filter(e=>{ const k=_normSecKey(e.sec); return k==='SLIT' || slitKeys.has(k); });
  }
  if(schedSec==='GRP:manager'){
    return all.filter(e=>{ const k=_normSecKey(e.sec); return k==='MGR' || k==='MANAGER'; });
  }
  return all.filter(e=>e.sec===schedSec);
}
...
async function getShiftConfig(keyOverride){
  ...
  try{
    ...
    const cfg=rec||_defaultShiftConfig();
...
function applyLang(){
  ...
  if(brand) brand.innerHTML = isEn
    ? '<span>M·P</span> Metalliser'
    : '<span>M·P</span> मेटलाइज़र';
...
function isMgr(){ 
  ...
  const emp = myEmp();
  return emp && (emp.accessLevel==='manager' || emp.sec==='MGR' || emp.designation==='Manager' || SESSION.empId==='30000463');
}
...
function showLoginErr(msg){ showLoginErrStep(2,msg); }
...
async function proceedFromCode(){
  ...
  const restoreBtn=()=>{ if(btn){ btn.innerHTML='Proceed →'; btn.style.opacity='1'; btn.style.pointerEvents='auto'; } };

  try{
    let empData=null;
    try{ empData=await fbGet('employees'); }catch(e){}
    const emps=empData?Object.values(empData):(_cache.employees||[]);
    if(emps.length) _cache.employees=emps;

    const match=emps.find(e=>e.empId&&e.empId.trim().toUpperCase()===code);

    if(match){
      try{
        const appr=await fbGet('userApprovals/'+match.id);
        if(appr&&appr.status==='revoked'){
          showLoginErrStep(2,'❌ आपकी access Admin ने बंद की है। +91-8929394920 पर संपर्क करें।');
          restoreBtn(); return;
        }
      }catch(e){}
      ...
      restoreBtn();
      showLoginApprovalOverlay(match, null);
    } else {
      let regData=null;
      ...
      if(existingReg){
        if(existingReg.status==='approved'){
          const fakeMatch={id:existingReg.linkedEmpId||code,name:existingReg.name,empId:code,sec:existingReg.sec||existingReg.dept||'MET'};
          restoreBtn(); showLoginApprovalOverlay(fakeMatch, existingReg); return;
        } else if(existingReg.status==='pending'){
          restoreBtn(); showPendingBox(); return;
        } else {
          showLoginErrStep(2,'❌ Registration अस्वीकार। +91-8929394920 पर संपर्क करें।');
          restoreBtn(); return;
        }
      }
      restoreBtn();
      showNewEmpRegistrationForm(code);
    }
  }catch(err){
    console.error('proceedFromCode error:',err);
    showLoginErrStep(2,'❌ Error: '+err.message);
    restoreBtn();
  }
}
  ...
  ov.innerHTML=`
    <div style="width:100%;max-width:360px">
      <div style="text-align:center;margin-bottom:20px">
        ...
        <div style="font-size:13px;color:#94a3b8;margin-top:4px">${emp.name} · ${emp.empId}</div>
      </div>
      <div style="background:#1e293b;border:1.5px solid #334155;border-radius:14px;padding:16px;margin-bottom:12px">
        ...
        <input id="laPhone" type="tel" inputmode="numeric" placeholder="10 digit number" maxlength="10"
          ...
          oninput="this.value=this.value.replace(/\\D/g,'').slice(0,10);_laValidate()">
      </div>
      <div style="background:#1e293b;border:1.5px solid #334155;border-radius:14px;padding:16px;margin-bottom:14px">
        <div style="font-size:11px;font-weight:800;color:#64748b;letter-spacing:1px;margin-bottom:10px">SELFIE PHOTO * (Verification के लिए)</div>
        <div style="width:100%;height:150px;border-radius:10px;background:#0f172a;border:2px dashed #334155;
          display:flex;align-items:center;justify-content:center;margin-bottom:10px;overflow:hidden;cursor:pointer"
          onclick="document.getElementById('laSelfieInput').click()">
          <div id="laSelfiePlaceholder" style="text-align:center;color:#475569">
            <div style="font-size:36px;margin-bottom:6px">📸</div>
            <div style="font-size:13px;font-weight:700">Tap to take Selfie</div>
          </div>
          <img id="laSelfieImg" style="display:none;width:100%;height:100%;object-fit:cover;border-radius:10px">
        </div>
        <input id="laSelfieInput" type="file" accept="image/*" capture="user" style="display:none"
          onchange="previewLASelfie(this)">
        <button onclick="document.getElementById('laSelfieInput').click()"
      ...
      <div id="laErr" style="color:#f43f5e;font-size:13px;text-align:center;min-height:18px;margin-bottom:8px"></div>
      <button id="laSubmitBtn" onclick="submitLoginWithSelfie()"
        style="width:100%;padding:16px;background:linear-gradient(135deg,#f97316,#a855f7);border:none;
        ...
        ✅ Verify करके Login Request भेजें
      </button>
      <button onclick="cancelLoginRequest()" style="width:100%;padding:13px;background:none;
        border:1px solid #334155;border-radius:12px;color:#64748b;font-size:14px;cursor:pointer;font-family:inherit">
        ← वापस जाएं
      </button>
    </div>`;
}

function previewLASelfie(input){
  if(!input.files||!input.files[0]) return;
  const reader=new FileReader();
  reader.onload=e=>{
    const img=document.getElementById('laSelfieImg');
    const ph=document.getElementById('laSelfiePlaceholder');
    if(img){img.src=e.target.result;img.style.display='block';}
    if(ph) ph.style.display='none';
    window._laSelfieData=e.target.result;
    _laValidate();
  };
  reader.readAsDataURL(input.files[0]);
}

function _laValidate(){
  const phone=(document.getElementById('laPhone')?.value||'').trim();
  const ok=phone.length===10&&!!window._laSelfieData;
  const btn=document.getElementById('laSubmitBtn');
  if(btn){btn.style.opacity=ok?'1':'.4';btn.style.pointerEvents=ok?'auto':'none';}
}

async function submitLoginWithSelfie(){
  const emp=window._laEmp; const existingReg=window._laExistingReg;
  const phone=(document.getElementById('laPhone')?.value||'').trim();
  const errEl=document.getElementById('laErr');
  if(phone.length!==10){if(errEl)errEl.textContent='❌ 10 digit mobile number डालें';return;}
  if(!window._laSelfieData){if(errEl)errEl.textContent='❌ Selfie लें';return;}
  const btn=document.getElementById('laSubmitBtn');
  if(btn){btn.innerHTML='⏳ Upload हो रहा है...';btn.style.opacity='0.7';btn.style.pointerEvents='none';}
  if(errEl) errEl.textContent='';

  // Upload selfie — but NEVER block on failure
  let selfieUrl=null;
  try{
    if(typeof window._fbUploadSelfie==='function'){
      const path='selfies/login/'+emp.id+'_'+Date.now()+'.jpg';
      selfieUrl=await window._fbUploadSelfie(window._laSelfieData, path);
    }
  }catch(e){console.warn('[selfie]',e);}
  ...
  if(ov) ov.innerHTML=`
    <div style="width:100%;max-width:360px;text-align:center">
      ...
      <div style="background:#1e293b;border:1.5px solid rgba(249,115,22,.4);border-radius:16px;padding:18px;margin:16px 0;text-align:left">
        <div style="font-size:11px;color:#64748b;font-weight:800;letter-spacing:1px;margin-bottom:8px">EMPLOYEE</div>
        <div style="font-size:18px;font-weight:900;color:#f97316">${emp.name}</div>
        <div style="font-size:13px;color:#94a3b8;margin-top:3px">${emp.empId} &middot; ${secLabel}</div>
        ${selfieUrl?`<img src="${selfieUrl}" style="width:64px;height:64px;border-radius:10px;object-fit:cover;border:2px solid rgba(249,115,22,.4);margin-top:8px">`:''}
      </div>
      <div id="laStatus" style="background:rgba(249,115,22,.08);border:1px solid rgba(249,115,22,.2);
        border-radius:12px;padding:14px;margin-bottom:16px;font-size:13px;color:#94a3b8;line-height:1.9">
        &#9203; Admin को notification भेजी जा रही है...<br>
        <span style="color:#64748b;font-size:11px">Approval के बाद automatically login होगा</span>
      </div>
      <div id="laSpinner" style="margin-bottom:16px">
        <div style="width:44px;height:44px;border:3px solid rgba(249,115,22,.2);border-top-color:#f97316;
          border-radius:50%;animation:spin 1s linear infinite;margin:0 auto"></div>
      </div>
      <div style="font-size:12px;color:#64748b;margin-bottom:16px">
        &#128222; Jaldi approval: <a href="tel:+918929394920" style="color:#f97316;font-weight:800;text-decoration:none">+91-8929394920</a>
      </div>
      <button onclick="cancelLoginRequest()" style="width:100%;padding:13px;background:none;
        border:1px solid #334155;border-radius:12px;color:#64748b;font-size:14px;cursor:pointer;font-family:inherit">
        &larr; वापस जाएं
  ...
  sendLoginApprovalRequest(emp, existingReg, phone, selfieUrl);
}

async function sendLoginApprovalRequest(emp, existingReg, phone, selfieUrl){
  const deviceId=getDeviceId();
  const statusEl=document.getElementById('laStatus');
  try{
    // ── Sign in anonymously so Firebase rules (auth != null) work during login flow ──
    try{ await window._fbSignInAnon(); }catch(e){ console.warn('[login] Anon auth failed:', e.message); }
    
    let dRec=null;
    try{ dRec=await fbGet('deviceApprovals/'+emp.id); }catch(e){}
    if(dRec&&dRec.approvedDeviceId===deviceId){
      // Save phone if provided (may not have been saved during original approval)
      if(phone && phone.length===10 && emp.id){
        try{ await fbUpdate('employees/'+emp.id, { phone: phone }); }catch(e2){}
      }
      doLoginAfterApproval(emp, existingReg, deviceId); return;
    }
    const reqKey=await fbPush('loginRequests',{
      empId:emp.empId, empObjId:emp.id, empName:emp.name, empSec:emp.sec||'MET',
      deviceId, status:'pending', requestedAt:new Date().toISOString(),
      isNewReg:existingReg?true:false,
      phone:phone||'', selfieUrl:selfieUrl||''
    });
    await fbUpdate('loginRequests/'+reqKey,{_key:reqKey});
    _loginApprovalKey=reqKey;
...
async function checkLoginApproval(emp, existingReg, reqKey, deviceId){
  try{
    ...
    if(rec.status==='approved'){
      ...
      if(statusEl) statusEl.innerHTML='&#10060; Admin ne login reject kiya.<br>+91-8929394920 par sampark karein.';
    }
  }catch(e){}
}
...
async function doLoginAfterApproval(emp, existingReg, deviceId){
  ...
  try{
    const result = await Promise.race([
      window._fbCall('workerLogin', { empId: emp.empId, deviceId }),
      new Promise((_, rej) => setTimeout(() => rej(new Error('timeout')), 8000))
    ]);
    if(result.data && result.data.token){
      await window._fbSignInWithToken(result.data.token);
    ...
    console.warn('[workerLogin] CF auth failed, using anonymous:', cfErr.message);
    try{ await window._fbSignInAnon(); }catch(e){}
  }
...
async function launchApp(){
  ...
  // Skip for admin, guest, and MGR role (VIVEK) — they never expire
...
function _renderShiftSettingsModal(){
  ...
  <div style="font-size:12px;font-weight:800;color:#38bdf8;margin:18px 0 8px">✂️ Slitter Machines</div>
  <div id="ss_slitters">${_renderMachineRows('slitters')}</div>
  <button class="cancel-btn" style="margin-top:6px" onclick="_addMachine('slitters')">+ Slitter जोड़ें</button>

  <div style="font-size:11px;color:#64748b;margin-top:14px;line-height:1.6">
    💡 Machine names sequential होना जरूरी नहीं — जैसे "Met-1, Met-3, Met-5" भी चल सकता है।
  </div>
...
async function renderHome(){
  ...
  const stillLoading = _cache.employees === null; // Firebase hasn't responded yet — genuinely loading
  if(!emps || emps.length===0){
    ...
    document.getElementById('homeStats').innerHTML=`
      <div class="stat-card"><div class="stat-val" style="color:var(--muted)">...</div><div class="stat-lbl" id="dayStatLbl">${_lang==='en'?'Day Shift':'दिन शिफ्ट'}</div></div>
      <div class="stat-card"><div class="stat-val" style="color:var(--muted)">...</div><div class="stat-lbl" id="nightStatLbl">${_lang==='en'?'Night Shift':'रात शिफ्ट'}</div></div>
    ...
    if(stillLoading){
      ...
      document.getElementById('homeSections').innerHTML=`<div style="text-align:center;padding:30px 16px;color:var(--muted2)">
        ...
        <div style="font-size:14px;font-weight:700;color:var(--text);margin-bottom:6px">${_lang==='en'?'Your team is empty':'आपकी Team में अभी कोई नहीं है'}</div>
        <div style="font-size:12px;line-height:1.6">${_lang==='en'?'Add employees from the Team tab to get started.':'शुरू करने के लिए टीम टैब से कर्मचारी जोड़ें।'}</div>
      </div>`;
    } else {
      document.getElementById('homeSections').innerHTML='<div style="text-align:center;padding:20px;color:var(--muted2)">'+(_lang==='en'?'No data yet.':'अभी कोई डेटा नहीं है।')+'</div>';
    }
  ...
  if(isAdminOrMgr()){
    ...
    document.getElementById('homeStats').innerHTML=`
      <div class="stat-card"><div class="stat-val" style="color:var(--day)">${dayE}</div><div class="stat-lbl" id="dayStatLbl">${_lang==='en'?'Day Shift':'दिन शिफ्ट'}</div></div>
    ...
    return members.map(e=>{
      ...
      return `<div class="card" id="teamcard_${e.id}" style="${isMe?'border-color:rgba(249,115,22,.4);background:rgba(249,115,22,.04);':''}">
        <div class="card-row">
          ...
          <div class="card-body">
            <div class="card-name">${e.name}${isMe?' <span style="font-size:10px;color:var(--m1)">(आप)</span>':''}</div>
            <div class="card-sub">${e.empId||'—'} · ${e.mc||'—'} · ${e.resp||'—'}${e.designation?` · <span style="color:var(--desig-color,#7c3aed)">${escHtml(e.designation)}</span>`:''}</div>
            <div style="margin-top:5px;display:flex;align-items:center;gap:6px;flex-wrap:wrap">
              <span class="shc ${cellClass(sh)}">${cellDisp(sh)}</span>
              <span style="font-size:10px;color:var(--muted)">W-OFF: ${e.woff||'—'}</span>
              ${e.phone?`<span style="font-size:10px;color:var(--green)">📱 ${e.phone}</span>`:''}
              ${ncrBadge}
            </div>
...
function renderSalaryCost(){
  ...
  rows.forEach(r => {
    if(r.emp.sec !== lastSec){
      ...
      html += `<tr style="background:var(--bg2)"><td colspan="5" style="padding:5px 10px;font-size:9px;font-weight:800;color:${s.color};letter-spacing:1.5px;text-transform:uppercase">${s.hi||r.emp.sec}</td></tr>`;
    }
...
async function loadDeviceManagerContent(empId, empName){
  ...
  try{
    ...
    el.innerHTML=`<div style="color:#f43f5e;font-size:13px">Error: ${e.message}</div>`;
  }
}
...
function showEmpNcrs(empId){
  ...
  const rows = sorted.map(n=>{
    ...
    return `<div style="background:rgba(244,63,94,.05);border:1px solid rgba(244,63,94,.2);border-radius:10px;padding:11px 13px;margin-bottom:8px">
      ...
      <div style="font-size:13px;color:var(--text);line-height:1.5">${n.reason}</div>
      ${n.names.length>1?`<div style="font-size:11px;color:var(--muted2);margin-top:5px">👥 साथ: ${n.names.filter(nm=>{const id=NCR_NAME_MAP[nm]; return id&&id!==empId;}).join(', ')||'—'}</div>`:''}
    </div>`;
  }).join('');
  ...
  openModal(`<div class="modal-handle"></div>
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:16px">
      ...
      <div>
        <div style="font-size:17px;font-weight:900;color:#fff">${emp.name}</div>
  ...
  let sectionsHTML = sections.map(([key, sec])=>`
    <div style="background:rgba(255,255,255,.04);border:1px solid var(--border);border-radius:12px;padding:12px;margin-bottom:12px">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">
        <input value="${sec.title||''}" id="isec_title_${key}" style="background:rgba(255,255,255,.08);border:1px solid var(--border);border-radius:8px;padding:7px 10px;color:#fff;font-size:13px;font-weight:700;width:calc(100% - 60px);font-family:inherit">
...
const _i18n_HI_EN = {
  ...
  '✅ Request भेज दी! VIVEK approve करेंगे।': '✅ Request sent! VIVEK will approve.',
  '✅ Request भेज दी! VIVEK verify करेंगे।': '✅ Request sent! VIVEK will verify.',
  ...
  '📲 ${waQueue[0].emp.name} को WhatsApp भेजा': '📲 WhatsApp sent to ${waQueue[0].emp.name}',
  ...
  '✏️ ${e.name} संपादित करें':               '✏️ Edit ${e.name}',
...
function _updateSaveBar(){
  ...
  list.innerHTML = entries.map(e=>{
    ...
    return `<div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,.04);border-radius:8px;padding:8px 10px">
      ...
      <div style="flex:1;min-width:0">
        <div style="font-size:13px;font-weight:800;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${e.empName}</div>
        <div style="font-size:11px;color:var(--muted2)">${fmtD}</div>
      </div>
      <button onclick="removePendingChange('${e.empId}','${e.date}')" style="background:none;border:none;color:var(--lv);font-size:16px;cursor:pointer;padding:4px;flex-shrink:0">✕</button>
    </div>`;
  }).join('');
}
...
async function saveAllShiftChanges(){
  ...
  try{
    // Build only the changed keys — don't read/overwrite entire overrides object
    // This prevents data loss, reduces Firebase write size, and avoids rule conflicts
    const updates = {};
  ...
  overlay.innerHTML = `
    <div style="background:var(--bg2);border-radius:20px 20px 0 0;padding:24px 20px 40px;width:100%;max-width:480px;border-top:1px solid var(--border2);animation:slideUp .25s cubic-bezier(.32,0,.15,1)">
      ...
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:6px">
        ...
        <div>
          <div style="font-size:17px;font-weight:900;color:var(--text)">${emp.name}</div>
          <div style="font-size:12px;color:var(--muted2)">📱 +91 ${emp.phone}</div>
        </div>
      ...
      <button id="_waSendBtn"
        ...
        WhatsApp भेजें — ${emp.name.split(' ')[0]}
      </button>
  ...
  reader.onload=function(e){
    if(file.type.startsWith('image/')){
      ...
      if(prev) prev.innerHTML=`<div style="margin-top:6px;padding:8px;background:var(--card);border:1px solid var(--border2);border-radius:8px;font-size:11px;color:var(--text)">
        📄 ${file.name} <button onclick="_leaveImgBase64=null;this.parentElement.remove()" style="background:#ef4444;border:none;color:#fff;border-radius:4px;padding:2px 6px;cursor:pointer;font-size:10px;margin-left:8px">✕</button>
      </div>`;
    }
  };
  reader.readAsDataURL(file);
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
      ${SHIFT_OPTIONS.map(s=>`
        <button onclick="handleShiftBtnClick('${empId}','${empName}','${date}','${currentShift}','${s.v}')"
          ...
          <span style="font-size:12px;text-align:left;line-height:1.3">${s.label}</span>
          ${''}
        </button>`).join('')}
    </div>
    ...
    <div style="background:#1e293b;border:1px solid #334155;border-radius:20px 20px 0 0;padding:20px 18px 30px;width:100%;max-width:480px;max-height:90vh;overflow-y:auto">
      ...
      <div id="coWorkedDateSel" style="margin-bottom:14px">
        ...
        <div id="coDateCards" style="display:flex;flex-direction:column;gap:6px;max-height:180px;overflow-y:auto;padding:2px">
          ${dateOpts.map(o=>`<div class="co-date-card" onclick="selectCoDate(this,'${o.ds}',${o.isHoli},'${(o.holiName||'').replace(/'/g,'\\&#39;')}',${o.isWoff})" data-val="${o.ds}"
            ...
            <div>
              <span style="font-size:16px !important;font-weight:900 !important;color:#fde68a !important;display:block">${o.isHoli?o.holiName:'W-OFF'} — ${o.label.split('(')[0].trim()}</span>
...
function findLastShiftBeforeMonth(emp, targetYr, targetMo, validShiftCodes){
  // Search backwards through months to find last valid shift code (from config).
  // ALSO counts how many off-days (O) were encountered between that
  // last shift and the target month, so caller can advance rotation correctly.
  // Returns: { shift, offsAfter: number }
  const shiftSet = new Set(validShiftCodes || ['D','N']);
  const MONTH_ORDER = [
    '2026_04','2026_03','2026_02','2026_01',
    '2025_12','2025_11','2025_10','2025_09','2025_08'
  ];

  // Also check Firebase schedules (may have future months saved)
  const fbScheds = getSchedules() || {};

  // Build list of months to scan backwards from (targetYr_targetMo - 1)
  let scanYr = targetYr, scanMo = targetMo - 1;
  if(scanMo === 0){ scanMo = 12; scanYr--; }

  // Track off-days seen while walking backwards from target month
  // (i.e. days AFTER the last shift, chronologically)
  let offsAfter = 0;

  for(let attempt = 0; attempt < 18; attempt++){
    const mk = `${scanYr}_${String(scanMo).padStart(2,'0')}`;
    const daysInScanMo = new Date(scanYr, scanMo, 0).getDate();

    // Helper: scan a month array backwards, counting offs and returning shift
    const scanArr = (arr) => {
      for(let d = daysInScanMo - 1; d >= 0; d--){
        const sh = arr[d];
        if(shiftSet.has(sh)) return { shift: sh, offsAfter };
        if(sh === 'O') offsAfter++;
      }
      return null;
    };

    // Check Firebase saved first
    if(fbScheds[mk] && fbScheds[mk][emp.id]){
      let arr = fbScheds[mk][emp.id];
      if(arr && !Array.isArray(arr)) arr = Object.values(arr);
      if(arr){
        const res = scanArr(arr);
        if(res) return res;
      }
    }

    // Check EXCEL_SCHEDULES
    if(typeof EXCEL_SCHEDULES !== 'undefined' && EXCEL_SCHEDULES[mk] && EXCEL_SCHEDULES[mk][emp.id]){
      const res = scanArr(EXCEL_SCHEDULES[mk][emp.id]);
      if(res) return res;
    }

    // Also check emp.ms (March 2026 hardcoded in employee object)
    if(scanYr === 2026 && scanMo === 3 && emp.ms && emp.ms.length){
      for(let d = emp.ms.length - 1; d >= 0; d--){
        const sh = emp.ms[d];
        if(shiftSet.has(sh)) return { shift: sh, offsAfter };
        if(sh === 'O') offsAfter++;
      }
...
function autoGenSchedule(monthKey){
  ...
  // cells with [data-empid] which would pollute the result and shift values
  const sbTbody = document.getElementById('sb_tbody');
  if(!sbTbody){ toast('⚠️ पहले Schedule खोलें'); return; }

  // Check if any cells exist in the grid (modal must be open)
  ...
  emps.forEach(emp => {
    ...
    // filled day, instead of blindly regenerating the whole month from scratch.
    const cellsArr = Array.from(cells).sort((a,b)=>(+a.dataset.day)-(+b.dataset.day));
    let lastFilledDayIdx = -1;
    let lastFilledShift = null;
    let offsSinceLastShift = 0;
    cellsArr.forEach((c,i)=>{
      const v = c.dataset.val || '';
      if(v){
        lastFilledDayIdx = i;
        if(configShiftCodes.includes(v)){ lastFilledShift = v; offsSinceLastShift = 0; }
        else if(v === 'O'){ offsSinceLastShift++; }
      }
    });

    let curShiftIdx, startDay;
    if(lastFilledDayIdx >= 0 && lastFilledShift){
      // Continue from already-filled data already sitting in this month's grid
      curShiftIdx = rotationOrder.indexOf(lastFilledShift);
      if(curShiftIdx===-1) curShiftIdx=0;
      for(let i=0;i<offsSinceLastShift;i++){ curShiftIdx=(curShiftIdx+1)%rotationOrder.length; }
      startDay = lastFilledDayIdx + 1; // only generate days AFTER the last already-filled day
    }else{
      // Nothing filled yet this month at all — fall back to previous month's continuation
      const lastInfo = findLastShiftBeforeMonth(emp, yr, mo, configShiftCodes);
      curShiftIdx = rotationOrder.indexOf(lastInfo.shift);
      if(curShiftIdx===-1) curShiftIdx=0;
    ...
    // Generate — preserve already-filled days as-is, protect approved leaves,
    // and only auto-fill days from startDay onwards
    const schedule = [];
    for(let d = 0; d < daysInMonth; d++){
      if(d < startDay){
        schedule.push(cellsArr[d] ? (cellsArr[d].dataset.val || '') : '');
        continue;
      }
...
async function _execPrint(){
  ...
  PRINT_GROUPS.forEach(grp=>{
    ...
    tbodyHtml+=`<tr><td colspan="${dates.length+1}" style="background:#1e293b;color:#fff;font-weight:900;font-size:10.5px;padding:5px 10px;text-align:left;letter-spacing:.6px;border:1px solid #334155">${grp.label}</td></tr>`;
    members.forEach(emp=>{
      ...
      tbodyHtml+=`<tr style="background:${isMain?'#fffbeb':'#fff'}">
        <td style="background:${isMain?'#fefce8':'#f8fafc'};text-align:left;padding:3px 6px;white-space:nowrap;border-right:2px solid #334155;border-bottom:1px solid #e2e8f0">
          <div style="font-weight:${isMain?'900':'700'};font-size:10px;color:#000">${isMain?'⭐ ':''}${emp.name}</div>
          <div style="font-size:8px;color:#555;margin-top:1px">${emp.empId||''}</div>
        </td>
        ${dates.map(d=>{
          const sh=getShift(emp,d)||'';
          const isT=d===TODAY_STR;
...
function editPlanPrice(plan){
  ...
  openModal(`<div class="modal-handle"></div>
  <div style="font-size:20px;margin-bottom:4px">${pi.icon} ${pi.name}</div>
...
function openLearnSection(section){
  ...
  if(section === 'metrain'){
    ...
    if(fr){
      ...
      setTimeout(()=>{ fr.src=''; setTimeout(()=>{ fr.src='metcost_pro.html'; },100); },50);
    }
...
window.openSupSkillVideoAdmin = function(){
  ...
  const rows = lessons.map(l=>`
    <div style="margin-bottom:11px;">
      <div style="font-size:10px;font-weight:800;color:#00b4a0;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px;">${l.label}</div>
      <div style="display:flex;gap:6px;">
...
function selectPlan(plan){
  ...
  proceedBtn.innerHTML = `<button class="learn-pay-btn" onclick="proceedToPayment()" style="margin-bottom:8px">
    ${pi.icon} ${pi.name} लें — ₹${getPrice(plan)}/month →
  </button>`;
  ...
  fbGet('learnButtons').then(data=>{
    ...
    const listHTML = btns.map(([key,btn])=>`
      <div style="display:flex;align-items:center;gap:8px;background:rgba(255,255,255,.04);border:1px solid var(--border);border-radius:10px;padding:10px 12px;margin-bottom:8px">
        ...
        <div style="flex:1;min-width:0">
          <div style="font-size:13px;font-weight:700;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${btn.label}</div>
    ...
    <div style="display:flex;flex-wrap:wrap;gap:10px;padding:4px 0">
      ${btns.map(btn=>`
        <button onclick="window.open('${btn.url}','_blank')" style="display:flex;align-items:center;gap:8px;background:linear-gradient(135deg,${btn.color}22,${btn.color}11);border:1.5px solid ${btn.color}55;border-radius:12px;padding:10px 14px;cursor:pointer;color:#fff;font-size:13px;font-weight:700;font-family:inherit;flex:1;min-width:140px;max-width:calc(50% - 5px)">
          ...
          <span style="text-align:left;line-height:1.3;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${btn.label}</span>
        </button>`).join('')}
    </div>`;
}
...
const LEARN_MODULES = {
  demo: {
    ...
    lessons:[
      { id:'d1', title:'Welcome to M·P Learn', desc:'What this platform covers and how to use it effectively.', audio:true, video:false, live:false },
          ...
          if(s){
            ...
            if(sess && sess.empObjId){
              ...
              if(freshEmp){
                ...
                const isMgrRole = accessLevel==='manager' || freshEmp.sec==='MGR' || freshEmp.empId==='30000463';
